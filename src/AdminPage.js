      ...
      <div style={{ maxWidth: '900px', margin: 'auto', padding: '30px' }}>
        ...
        {showAddForm && (
          <div style={{
            ...
            {/* IMAGE */}
            <input type="file" onChange={handleImageFile} style={{ marginBottom: '10px' }} />

            {imagePreview && (
              <img src={imagePreview} style={{ width: '120px', marginBottom: '10px' }} />
            )}

            <input placeholder="او لينك صورة"
              value={form.image}
