    ...
    <div style={{ minHeight: "100vh", background: C.bg, direction: "rtl" }}>
            ...
            <div style={{ padding: "24px" }}>
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <input
                  ...
                  style={{ width: "100%", padding: "12px 16px", borderRadius: "12px", border: `1px solid ${orderErrors.name ? "#e74c3c" : "#2A2A2A"}`, background: "#1A1A1A", color: C.text, fontSize: "14px", outline: "none" }}
                />
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <input
                  ...
                  style={{ width: "100%", padding: "12px 16px", borderRadius: "12px", border: `1px solid ${orderErrors.phone ? "#e74c3c" : "#2A2A2A"}`, background: "#1A1A1A", color: C.text, fontSize: "14px", outline: "none" }}
                />
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <textarea
                  ...
                  rows={2}
                  style={{ width: "100%", padding: "12px 16px", borderRadius: "12px", border: `1px solid ${orderErrors.address ? "#e74c3c" : "#2A2A2A"}`, background: "#1A1A1A", color: C.text, fontSize: "14px", outline: "none", resize: "none", fontFamily: "inherit" }}
                />
              ...
              <div style={{ marginBottom: "22px" }}>
                ...
                <textarea
                  ...
                  rows={2}
                  style={{ width: "100%", padding: "12px 16px", borderRadius: "12px", border: "1px solid #2A2A2A", background: "#1A1A1A", color: C.text, fontSize: "14px", outline: "none", resize: "none", fontFamily: "inherit" }}
                />
              </div>

              <button onClick={submitOrder} className="gold-btn" style={{
              ...
              <p style={{ textAlign: "center", color: "#444", fontSize: "11px", marginTop: "12px" }}>
      ...
      {selectedProduct && (
        <div style={{ position: "fixed", inset: 0, zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div onClick={() => { setSelectedProduct(null); setSelectedSize(null); setSizeError(false); }}
          ...
          <div style={{
            ...
            <button onClick={() => { setSelectedProduct(null); setSelectedSize(null); setSizeError(false); }}
              style={{
                position: "absolute", top: "12px", left: "12px",
