...
function JoxLogo({ size = 50 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="50" y="62" textAnchor="middle" fontFamily="Georgia, serif" fontWeight="900" fontSize="38" fill={COLORS.primary} letterSpacing="-2">JOX</text>
      <path d="M25 70 Q50 78 75 70" stroke={COLORS.primary} strokeWidth="2.5" fill="none" strokeLinecap="round" />
    </svg>
  );
}
    ...
    <div style={{
      ...
      <header style={{
        ...
        <button
          ...
          style={{
            ...
            cursor: 'pointer',
            boxShadow: totalItems > 0 ? '0 8px 22px rgba(27,51,37,0.18)' : 'none'
          }}
          onMouseEnter={e => {
        ...
        {filtered.length === 0 ? (
          ...
          <div
            ...
            onMouseEnter={e => {
              ...
              e.currentTarget.style.boxShadow = '0 14px 34px rgba(27,51,37,0.12)';
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <div style={{ color: COLORS.bg, fontSize: '14px' }}>📞 {STORE_INFO.phone}</div>
          <div style={{ color: COLORS.bg, fontSize: '14px' }}>📍 {STORE_INFO.location}</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '16px 24px' }}>
              {cart.length === 0 ? (
                <div style={{ textAlign: 'center', color: COLORS.muted, marginTop: '60px' }}>
                  <div style={{ fontSize: '48px', marginBottom: '16px' }}>🛒</div>
                  <p>السلة فاضية</p>
                </div>
              ) : cart.map((item, index) => (
                <div key={index} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <button onClick={() => updateQty(item.id, item.qty - 1)} style={qtyBtnLight}>-</button>
                      <span style={{ color: COLORS.text, fontWeight: '700', minWidth: '20px', textAlign: 'center' }}>{item.qty}</span>
                      <button onClick={() => updateQty(item.id, item.qty + 1)} style={qtyBtnDark}>+</button>
                      <span style={{ color: COLORS.primary, fontSize: '13px', marginRight: 'auto' }}>{item.price * item.qty} جنيه</span>
            ...
            {cart.length > 0 && (
              <div style={{ padding: '20px 24px', borderTop: `1px solid ${COLORS.border}` }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
                  ...
                  <span style={{ color: COLORS.primary, fontWeight: '800', fontSize: '18px' }}>{totalPrice} جنيه</span>
                </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ padding: '24px' }}>
              ...
              <p style={{ color: COLORS.muted, marginBottom: '16px', lineHeight: '1.6' }}>
